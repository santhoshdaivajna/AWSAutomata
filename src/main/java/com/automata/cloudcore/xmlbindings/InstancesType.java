 ...
 *       &lt;sequence>
 *         &lt;element name="member" type="{}InstanceType" maxOccurs="unbounded"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class InstancesType {
    ...
    protected List<InstanceType> member;
     ...
     * 
     */
    public List<InstanceType> getMember() {
        if (member == null) {
            member = new ArrayList<InstanceType>();
        }
        return this.member;
    }

	public void setMember(List<InstanceType> member) {
		this.member = member;
	}
