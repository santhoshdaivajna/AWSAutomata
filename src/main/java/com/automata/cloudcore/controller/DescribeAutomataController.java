...
public class DescribeAutomataController implements IController {
	...
	/** The Constant LOG. */
	private static final Logger logger = LoggerFactory.getLogger(DescribeAutomataController.class);
